...
var file_session_session_proto_rawDesc = string([]byte{
	...
	0x04, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0x2c, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65,
	...
	0x49, 0x64, 0x32, 0x86, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x13, 0x5a, 0x11, 0x67,
...
var file_session_session_proto_depIdxs = []int32{
	0, // 0: session.AuthService.Register:input_type -> session.RegisterRequest
	2, // 1: session.AuthService.Login:input_type -> session.LoginRequest
	1, // 2: session.AuthService.Register:output_type -> session.RegisterResponse
	3, // 3: session.AuthService.Login:output_type -> session.LoginResponse
