...
var file_pizza_pizza_proto_rawDesc = string([]byte{
	...
	0x72, 0x74, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x32, 0xb2, 0x07, 0x0a, 0x0c, 0x50, 0x69,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3b, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x50, 0x69, 0x7a, 0x7a, 0x61, 0x49, 0x6e, 0x43, 0x61, 0x72, 0x74, 0x12, 0x10, 0x2e, 0x70,
	...
	0x52, 0x65, 0x73, 0x70, 0x12, 0x4d, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x48,
	...
	0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x11,
	0x5a, 0x0f, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x64, 0x2f, 0x70, 0x69, 0x7a, 0x7a,
...
var file_pizza_pizza_proto_depIdxs = []int32{
	...
	19, // 17: pizza.PizzaService.UpdatePizzaInCart:input_type -> pizza.CartItems
	21, // 18: pizza.PizzaService.GetUserHistory:input_type -> pizza.GetCartHistoryRequest
	23, // 19: pizza.PizzaService.GetCartItemHistory:input_type -> pizza.GetCarItemtHistoryRequest
	1,  // 20: pizza.PizzaService.CreatePizza:output_type -> pizza.CreatePizzaResponse
	1,  // 21: pizza.PizzaService.CreatePizzaType:output_type -> pizza.CreatePizzaResponse
	3,  // 22: pizza.PizzaService.GetPizzas:output_type -> pizza.GetPizzasResponse
	6,  // 23: pizza.PizzaService.GetPizzaById:output_type -> pizza.GetPizzaByIdResponse
	8,  // 24: pizza.PizzaService.UpdatePizza:output_type -> pizza.UpdatePizzaResponse
	10, // 25: pizza.PizzaService.DeletePizza:output_type -> pizza.DeletePizzaResponse
	12, // 26: pizza.PizzaService.CheckIsCartExist:output_type -> pizza.CheckIsCartExistResponse
	14, // 27: pizza.PizzaService.Cart:output_type -> pizza.CartResponse
	16, // 28: pizza.PizzaService.CheckIsOrdered:output_type -> pizza.CheckIsOrderedResponse
	18, // 29: pizza.PizzaService.OrderPizza:output_type -> pizza.OrderPizzaResponse
	20, // 30: pizza.PizzaService.UpdatePizzaInCart:output_type -> pizza.CartItemsResp
	22, // 31: pizza.PizzaService.GetUserHistory:output_type -> pizza.GetCartHistoryResponse
	24, // 32: pizza.PizzaService.GetCartItemHistory:output_type -> pizza.GetCarItemtHistoryResponse
